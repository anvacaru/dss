...
contract ForkTest is DSTest {
    ...
    function test_fork_to_self() public {
        ...
        Assert.isTrue( ali.can_fork("gems", a, a, 8 ether, 4 ether), "");
        Assert.isTrue( ali.can_fork("gems", a, a, 4 ether, 2 ether), "");
        Assert.isTrue(!ali.can_fork("gems", a, a, 9 ether, 4 ether), "");
    }
    function test_give_to_other() public {
        ali.frob("gems", a, a, a, 8 ether, 4 ether);
        Assert.isTrue(!ali.can_fork("gems", a, b, 8 ether, 4 ether), "");
    ...
    function test_fork_to_other() public {
        ali.frob("gems", a, a, a, 8 ether, 4 ether);
        bob.hope(address(ali));
        Assert.isTrue( ali.can_fork("gems", a, b, 4 ether, 2 ether), "");
        Assert.isTrue(!ali.can_fork("gems", a, b, 4 ether, 3 ether), "");
        Assert.isTrue(!ali.can_fork("gems", a, b, 4 ether, 1 ether), "");
    }
    function test_fork_dust() public {
        ...
        Assert.isTrue( ali.can_fork("gems", a, b, 2 ether, 1 ether), "");
        Assert.isTrue(!ali.can_fork("gems", a, b, 1 ether, 0.5 ether), "");
    }
}
